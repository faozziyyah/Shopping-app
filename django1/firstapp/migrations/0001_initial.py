# Generated by Django 4.0.5 on 2022-12-12 12:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees', models.ManyToManyField(blank=True, to='firstapp.myclubuser')),
                ('venue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='firstapp.venue')),
            ],
        ),
    ]
